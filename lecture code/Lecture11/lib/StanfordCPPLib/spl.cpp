...
double GWindow::getHeight() const {
    return _iqmainwindow->frameGeometry().height();
}

GPoint GWindow::getLocation() const {
    QRect geom = _iqmainwindow->frameGeometry();
...
double GWindow::getWidth() const {
    return _iqmainwindow->frameGeometry().width();
}

double GWindow::getX() const {
    return _iqmainwindow->frameGeometry().x();
}

double GWindow::getY() const {
    return _iqmainwindow->frameGeometry().y();
}
